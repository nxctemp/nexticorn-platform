    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-[#E5E7EB] px-6 py-4 bg-white sticky top-0 z-10">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/login" className="text-sm border border-[#F6ACC1] text-[#111111] px-4 py-2 rounded-lg hover:border-[#E61952] hover:text-white hover:bg-[#E61952] transition-colors">Sign in</Link>
      ...
      <section className="bg-[#111111] text-white px-6 py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#9CA3AF] text-lg max-w-2xl mb-10 leading-relaxed">
            The Nexticorn Foundation is an independent umbrella advocacy organization for Indonesia’s tech, startup, and venture capital industry, aiming to advance and propel growth in the nation’s tech ecosystem through thought leadership, policy advocacy, and connectivity.
            Since its initiation in 2015, the Nexticorn Foundation has organized its flagship annual Nexticorn Summits, global outreach campaigns, and discussion forums, participated in by the industry’s key stakeholders, from top home-grown Indonesian startups and leading global investors to policymakers and corporations.
          </p>
          <div className="flex items-center gap-4">
            <Link href="/signup" className="bg-[#E61952] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#C01544] transition-colors">Become a Member</Link>
            <Link href="/login" className="border border-[#555] text-white px-6 py-3 rounded-lg font-medium hover:bg-white hover:text-[#111111] transition-colors">Member Portal</Link>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="px-6 py-20 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl font-bold text-[#111111] mb-6">About Nexticorn</h2>
      ...
      {/* Summit */}
      <section id="summit" className="px-6 py-20 bg-[#F7F7F8]">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#E61952] text-sm font-medium uppercase tracking-widest mb-4">Flagship Program</p>
          <h2 className="text-3xl font-bold text-[#111111] mb-4">The Nexticorn Summit</h2>
          ...
          <div className="grid grid-cols-4 gap-6">
            {[
              ...
              <div key={stat.label} className="bg-white rounded-xl border border-[#E5E7EB] p-6 text-center">
                <div className="text-3xl font-bold text-[#E61952] mb-2">{stat.number}</div>
      ...
      {/* Membership */}
      <section id="membership" className="px-6 py-20 bg-white">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#E61952] text-sm font-medium uppercase tracking-widest mb-4">Program</p>
          <h2 className="text-3xl font-bold text-[#111111] mb-4">Nexticorn Membership</h2>
          <p className="text-[#6B7280] leading-relaxed max-w-2xl mb-12">
          ...
          <div className="grid grid-cols-3 gap-6 mb-12">
            {[
              ...
              <div key={benefit.title} className="border border-[#E5E7EB] rounded-xl p-6 hover:border-[#E61952] transition-colors">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="border border-[#E5E7EB] rounded-xl p-8">
              ...
              <Link href="/signup" className="block text-center border border-[#E61952] text-[#E61952] rounded-lg py-2.5 text-sm font-medium hover:bg-[#FEE2E2] transition-colors">Request access</Link>
            </div>
            <div className="border border-[#E61952] rounded-xl p-8 relative">
              ...
              <Link href="/signup" className="block text-center bg-[#E61952] text-white rounded-lg py-2.5 text-sm font-medium hover:bg-[#C01544] transition-colors">Request access</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Board */}
      <section id="board" className="px-6 py-20 bg-[#F7F7F8]">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#E61952] text-sm font-medium uppercase tracking-widest mb-4">Leadership</p>
          <h2 className="text-3xl font-bold text-[#111111] mb-12">Board of Nexticorn</h2>
      ...
      {/* Final CTA */}
      <section className="px-6 py-20 bg-[#111111] text-white text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Join the Nexticorn network</h2>
      ...
      <footer className="border-t border-[#E5E7EB] px-6 py-8 bg-white">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <img src="/images/nxclogo.png" alt="Nexticorn" className="h-14 w-auto" />
          <p className="text-[#9CA3AF] text-sm">© 2026 Nexticorn Foundation. All rights reserved.</p>
